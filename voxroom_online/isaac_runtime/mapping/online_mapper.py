...
class OnlineMapper:
    def __init__(
        ...
        self.voxel_navigation_blind_zone_config = {
            ...
            "write_to_voxel_grid": bool(blind_cfg.get("write_to_voxel_grid", False)),
    ...
    def update(
        ...
        if bool(self.voxel_grid_config.enabled):
            ...
            self.last_voxel_blind_zone_debug = self._apply_voxel_navigation_blind_zone(
                base_pose_world,
                write_to_voxel=bool(self.voxel_navigation_blind_zone_config.get("write_to_voxel_grid", False)),
                write_to_grid=False,
            )
    ...
    def _apply_voxel_navigation_blind_zone(
        ...
        *,
        ...
        for reason, center_xy, radius_m in requests:
            ...
            if write_to_voxel and bool(cfg.get("write_to_voxel_grid", False)) and bool(self.voxel_grid_config.enabled):
