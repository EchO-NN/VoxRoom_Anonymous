    ...
    *,
    ...
    if room_labeler is None:
        ...
        if use_premerge:
            ...
            if _call_accepts_kwarg(update_params, "agent_rc"):
                update_kwargs["agent_rc"] = agent_rc
            if _call_accepts_kwarg(update_params, "agent_yaw_deg"):
                update_kwargs["agent_yaw_deg"] = agent_yaw_deg
            add_replay_style_navigation_update_kwargs(
                update_kwargs,
                update_params,
                navigation_free_mask=nav_free_arr,
